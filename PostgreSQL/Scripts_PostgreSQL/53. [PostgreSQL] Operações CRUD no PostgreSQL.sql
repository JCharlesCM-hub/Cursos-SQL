/* #=== Operações CRUD ===# --
53. [PostgreSQL] Operações CRUD no PostgreSQL
...
-- Atualizar BD, clicar btn direiro em DATABASES / REFRESH aparecera o BD "teste" criado. 
-- Para CONECTAR ao BD teste basta clicar com o btn esquerdo sobre BD teste.

-- Para Excluir / Deletar o BD teste tem que desconectar do BD.
	-- Clicar brn direito em BD teste, Clicar em "Disconnect from Database"
DROP DATABASE teste;        -- exclui um banco de dados criado
-- Para Excluir / Deletar o BD teste tem que desconectar do BD.
	-- Clicar brn direito em BD teste, Clicar em "Disconnect from Database"
-- Atualizar BD, clicar btn direiro em DATABASES / REFRESH o BD teste vai desaparecer. 

-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
-- CRIAR NOVO BD(hashtag)

-- Vamos criar um banco de dados de exemplo para este módulo do curso.
CREATE DATABASE hashtag;
-- Atualizar BD, clicar btn direiro em DATABASES / REFRESH aparecera o BD "hashtag" criado. 
-- Para CONECTAR ao BD hashtag basta clicar com o btn esquerdo sobre BD "hashtag".
