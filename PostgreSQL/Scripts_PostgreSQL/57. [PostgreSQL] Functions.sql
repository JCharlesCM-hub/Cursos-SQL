...
-- Atualizar Functios REFRESH
-- Executar função criada.
select analise_estoque(10, 50); -- resultado 42 

select count(*) from products; -- resultado 77 

select count(*) - analise_estoque(10, 50) from products;  -- resultado 77 - 42 = 35
